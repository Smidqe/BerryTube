...
const { Video } = require("./modules/playlist/video");
...
const { PlaylistService } = require("./modules/playlist/service");
...
const playlistService = serviceLocator.playlist = new PlaylistService(serviceLocator, eventServer);
